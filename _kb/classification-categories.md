...
{% include /svg/kb/classification-blackletter.svg %}{:width="320px"}
...
{% include /svg/kb/classification-humanist.svg %}{:width="480px"}
...
{% include /svg/kb/classification-old-style.svg %}{:width="320px"}
...
{% include /svg/kb/classification-transitional.svg %}{:width="480px"}
...
{% include /svg/kb/classification-modern.svg %}{:width="75%"}
...
{% include /svg/kb/classification-slab-serif.svg %}{:width="75%"}
...
{% include /svg/kb/classification-slab-serif-clarendon.svg %}{:width="75%"}
...
{% include /svg/kb/classification-sans-serif.svg %}{:width="75%"}
...
{% include /svg/kb/classification-sans-variants.svg %}{:width="75%"}
...
{% include /svg/kb/classification-script.svg %}{:width="75%"}
...
{% include /svg/kb/classification-decorative.svg %}{:width="75%"}
